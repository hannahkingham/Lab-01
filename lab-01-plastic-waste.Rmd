...
we want color and fill to be aplied to to one variable so we map them to aes but we want alpha to be aplied to the overall aes of the plot so we plot it to geom.
